...
This folder defines all source code for the 'gold_pipeline_gh' pipeline:
...
* Take a look at the sample under "sample_users_gold_pipeline_gh.py" to get familiar with the syntax.
